# -*- coding: utf-8 -*-
"""HandDrawingModel2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/18sq6qbNaunO1_RXxjrqbuyeiQzR57XDp
"""
...
trainset=datasets.ImageFolder(root="/content/drive/MyDrive/Parkinson's Disease /handDrawing/wave/training",transform=None)
testset=datasets.ImageFolder(root="/content/drive/MyDrive/Parkinson's Disease /handDrawing/wave/testing",transform=None)
...
class DataModule(pl.LightningDataModule):
    ...
    def __init__(self, transform=transform, batch_size=32):
        super().__init__()
        self.train_dir = "/content/drive/MyDrive/Parkinson's Disease /handDrawing/wave/training"
        self.test_dir = "/content/drive/MyDrive/Parkinson's Disease /handDrawing/wave/testing"
...
torch.save(model.state_dict(), 'parkinsons_wave_model.pkl')

model = ConvolutionalNetwork()
model.load_state_dict(torch.load('parkinsons_wave_model.pkl'))

new_image = Image.open("/content/V05PO01.png")
